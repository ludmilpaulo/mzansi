    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('ADMIN', 'Admin'), ('CONSULTANT', 'Immigration Consultant'), ('DOCUMENT_REVIEWER', 'Document Reviewer'), ('FINANCE', 'Finance'), ('SUPPORT', 'Support Agent'), ('CLIENT', 'Client')], db_index=True, default='CLIENT', max_length=32)),
